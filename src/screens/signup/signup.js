...
import { signupSuccess } from './ducks/SignupScreen.actions';
import { signupUser } from '../../utils/asyncUtil';
...
class LoginScreen extends Component {
    ...
    validationSchemaMobile = Yup.object().shape({
        ...
        mobile: Yup.number()
        .min(1111111111, 'Invalid Length')
        .max(9999999999, 'Invalid Length')
...
const mapDispatchToProps = dispatch => bindActionCreators({
    login: (data) => dispatch(signupSuccess(data))
}, dispatch);
